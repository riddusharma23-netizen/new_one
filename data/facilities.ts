...
export const facilities = [
...

  {
    ...
    description:
      "Annual value-based spiritual tours in collaboration with ISKCON Vrindavan for moral science and character building.",
    ...
    content:
      "Tours provide students with meaningful experiences where they can discover new places, understand different traditions and connect classroom learning with real-world experiences.",
...
highly qualified lecturers providing personalized academic attention to every student.`,
    ...
    heading: "Inspiring Students To Achieve More",

    content:
      "Our teachers play an important role in helping students develop knowledge, confidence and skills for their future.",
...

  {
    ...
    content:
      "English speaking activities provide students with regular opportunities to practice communication in an engaging and supportive environment.",
