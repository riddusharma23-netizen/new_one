  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl p-10">
      <div className="flex justify-between flex-wrap">
        <div>
          <h2 className="text-3xl font-bold text-[#072F60]">{data.studentName}</h2>
        ...
        <div className="bg-green-100 rounded-xl px-8 py-4 h-fit">
          <h3 className="text-green-700 text-2xl font-bold">PASS</h3>
        </div>
      </div>
      ...
      <table className="w-full mt-10">
        ...
        <tbody>
          {data.subjects.map((item, index) => (
            <tr key={`${item.subject}-${index}`} className="text-center border-b">
